  ...
  sections: [
    ...
    },
    {
      diagram: {
        id: "rb-9-1",
        caption:
          "Every VLA is one pipeline: image and instruction in, a shared VLM backbone in the middle, an action head on the end. The three action-head choices are the whole design space.",
      },
    },
    {
      quiz: {
    ...
    },
    {
      diagram: {
        id: "rb-9-2",
        caption:
          "Binning turns control into classification: a continuous command snaps to the nearest of 256 bins. Simple and language-model-friendly — but the red gap is the fidelity you throw away, and it comes back to bite at high frequency.",
      },
    },
    {
    ...
    },
    {
      list: [
        ...
        `**Discrete Cosine Transform (DCT)** each dimension. This is the workhorse — the same transform inside JPEG. The DCT re-expresses a time-series as a sum of cosine waves of increasing frequency, so instead of "the position at each of 50 timesteps" you now have "how much of each frequency is present." The slow, overall shape of the motion sits in the first few coefficients; the fast wiggle sits in the last ones.`,
