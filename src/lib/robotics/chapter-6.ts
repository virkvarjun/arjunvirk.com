...
row 2:  .   .   .   .`,
    ...
    },
    {
      list: [
        ...
        "**Expand (1,0)**: g=2. Neighbor (2,0): g=3, h=|3−2|+|1−0|=2, **f=5**. (Notice: every cell on the good detour keeps f=5, and that's the heuristic telling A* it's still on an optimal path.)",
    ...
    },
    {
      list: [
        ...
        "**Find** the node already in the tree that's nearest to `q_rand`, and call it `q_near`.",
