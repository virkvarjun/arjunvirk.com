  ...
  sections: [
    ...
    },
    {
      diagram: {
        id: "rb-3-3",
        caption:
          "The workspace is the arm's territory: a ring you can touch, with a smaller core you can touch from any angle. The edges reach but can't reorient — put the real work in the dexterous core.",
      },
    },
    {
    ...
    },
    {
      quiz: {
        question:
          "A pick-and-place robot only ever needs to move its gripper to an (x, y, z) position and point it straight down — the yaw around the vertical doesn't matter for the round parts it handles. How many degrees of freedom does that task actually require, and what does that let the designer do?",
        answer:
